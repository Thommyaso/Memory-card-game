  ...
  _createClass(Card, [{
    ...
    value: function draw(ctx) {
      ...
      this.img.onload = function () {
        ctx.drawImage(_this.img, _this.x, _this.y, 80, 80);
      };
    }
  }]);
  return Card;
...
for (var b = 0; b < 5; b += 1) {
  for (var i = 0; i < 5; i += 1) {
    imgArr.push(new _card__WEBPACK_IMPORTED_MODULE_0__["default"]('../assets/images/backofcard.svg', x, y));
    x += 80;
  }
  x = 0;
  y += 80;
